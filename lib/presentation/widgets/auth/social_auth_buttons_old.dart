...
class SocialAuthButtons extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        _SocialButton(
          icon: Icons.facebook,
          label: isLogin ? 'Continuer avec Facebook' : 'S\'inscrire avec Facebook',
        ...
        _SocialButton(
          icon: Icons.business,
          label: isLogin ? 'Continuer avec LinkedIn' : 'S\'inscrire avec LinkedIn',
  ...
  Future<Map<String, dynamic>> _appleAuthFlow() async {
    ...
    if (DateTime.now().millisecond % 10 < 8) {
      ...
      return {
        'success': false,
        'error': 'Connexion Apple ID annulée'
      };
    }
  }
  ...
  Future<Map<String, dynamic>> _facebookAuthFlow() async {
    ...
    if (DateTime.now().millisecond % 10 < 8) {
      ...
      return {
        'success': false,
        'error': 'Connexion Facebook refusée'
      };
    }
  }
  ...
  Future<Map<String, dynamic>> _linkedInAuthFlow() async {
    ...
    if (DateTime.now().millisecond % 10 < 8) {
      ...
      return {
        'success': false,
        'error': 'Autorisation LinkedIn requise'
      };
    }
  }
  ...
  void _showAuthError(BuildContext context, String provider, [String? customError]) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
